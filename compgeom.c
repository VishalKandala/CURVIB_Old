			  ...
			  PetscReal *t, PetscReal *u, PetscReal *v)
{
  ...
  if (det > -EPSILON && det < EPSILON) // If the dir vector is in same plane as the immersed boundary element, it is considered as not intersecting.
    return 0; 
